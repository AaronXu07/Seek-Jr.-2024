...
int DIR_L_F = 4;    // Left Direction pin that will indicate forewards movement (1 for forewards, 0 for backwards).
int DIR_L_B = 5;    // Left Direction pin that will indicate backwards movement (1 for backwards, 0 for forewards).
int PWM_L = 3;      // Speed controll pin. *** This pin must be plugged into an output pin on the arduino that is labled PWM ***.

int DIR_R_F = 7;     // Right Direction pin that will indicate forewards movement (1 for forewards, 0 for backwards)
int DIR_R_B = 8;     // Left Direction pin that will indicate backwards movement (1 for backwards, 0 for forewards).
int PWM_R = 9;       // Speed controll pin. *** This pin must be plugged into an output pin on the arduino that is labled PWM ***.
